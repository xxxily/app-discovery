...
<div class="hud-header">
  <h1 class="hud-title">
    <span class="hud-icon">🌍</span> 全平台应用分类目录
  </h1>
  <div class="hud-subtitle">
    <div class="typewriter-text">系统已为您整理全平台优质应用及开源替代方案，正在展开全景分类目录。
    <br><br>当前已收录 <strong style="color: var(--vp-c-brand-1)">{{ stats.totalProjects }}</strong> 个优质项目。请选取目标分类：<span class="cursor">_</span>
    </div>
  </div>
</div>
